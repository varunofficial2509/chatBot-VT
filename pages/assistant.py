...
components.render_nav_header(active="assistant", name=profile_meta.get("name", ""))
...
with st.container(key="vt_chat_col"):
    ...
    # The last turn is a user message awaiting a response (either just typed
    # via chat_input below, or just appended above before the rerun) —
    # generate and show the answer now.
